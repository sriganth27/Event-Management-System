...
public class EventDao {
	...
	public boolean eddEvent(event e) {
		...
		try {
			...
			ps.setString(8, e.getBroucher() );
			ps.setString(9, e.getImage1());
			ps.setString(10, e.getImage2());
	...
	public List<event> getAllEventByLoginDept(int Deptid){
		...
		try {
			...
			while(rs.next()) {
				...
				e.setBroucher(rs.getString(9));
				e.setImage1(rs.getString(10));
				e.setImage2(rs.getString(11));
