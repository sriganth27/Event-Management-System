   ...
   <div class="container-fluid p-3">
    <div class="row">
          ...
          <div class=" col-md-7 offset-md-3" >
						...
						<p class="fa2 fs-3 text-center">Update Event</p>
                ...
                <div class="card-body">
				  ...
				  <input type="hidden" name="deptid" value="${deptObj.id}">
				   ...
				   <select
				     name="eventcategory" for="dropdown" class="form-control" value="<%=d.getEventCategory()%>" >
				  ...
				  <div class="as col-md-12">
				   <label for="fa inputEmail4" class="form-label">Description</label>	
				  	<textarea required name ="description" class="form-control" row ="10" cols="10" value="<%=d.getDescription()%>" ></textarea>
