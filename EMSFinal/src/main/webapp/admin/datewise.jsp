...
<br>
		   ...
		   <form action="datewise.jsp" method="post">
              ...
              <div class="input-group">
			   <input type="text" name="Search1" class="form-control" placeholder="event_date like YYYY-MM-DD"> 
			   <input type="text" name="Search2" class="form-control" placeholder="event_date like YYYY-MM-DD"> 
